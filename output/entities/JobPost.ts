...
@Entity("job_post", { schema: "job_hire" })
export class JobPost {
  ...
  @Column("numeric", { name: "jopo_min_salary", nullable: true })
  jopoMinSalary: string | null;

  @Column("numeric", { name: "jopo_max_salary", nullable: true })
  jopoMaxSalary: string | null;
